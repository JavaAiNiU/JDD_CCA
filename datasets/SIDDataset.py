...
if __name__=='__main__':
    ...
    dataset = SIDSonyDataset(data_dir='/raid/hbj/datas/SID/Sony',image_list_file='Sony_train_list.txt',
    ...
    # data = dataset[7]
    # print(data)
    # input_raw, gt_raw, gt_rgb ,index = data['input_raw'], data['gt_raw'], data['gt_rgb'],data['index']
